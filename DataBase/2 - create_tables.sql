...
CREATE TABLE ObuStatus (
  	...
  	speed REAL NOT NULL DEFAULT 60.5,
  	location_properties jsonb,
  	usable_storage BIGINT NOT NULL DEFAULT 2048,
  	free_storage BIGINT NOT NULL DEFAULT 1024,
  	critical_alarms INT NOT NULL DEFAULT 0,
  	major_alarms INT NOT NULL DEFAULT 0,
  	warning_alarms INT NOT NULL DEFAULT 0,
  	temperature REAL NOT NULL DEFAULT 41.7,
